...
test('pipeline viewport guard contains desktop document scroll inside the real portal canvas', () => {
  ...
  assert.equal(source.includes('main.pipeline-aura-page > section.premium-shell'), true);
  assert.equal(source.includes('main.pipeline-aura-page > section.premium-shell > .premium-canvas.pipeline-aura-canvas'), true);
  assert.equal(source.includes('pipeline-aura-portal-shell'), false);
  assert.equal(source.includes('pipeline-aura-portal-canvas'), false);
