        ...
        {editingId === store.id ? (
          ...
          <>
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              {store.slug ? <a href={`/master/stores/stock/${encodeURIComponent(store.slug)}`} className="premium-button-secondary text-xs"><Package size={14} /> Gerenciar estoque</a> : null}
