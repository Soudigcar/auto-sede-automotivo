...
export function CampaignVisualEditorPreviewResponsive(props: Props) {
  ...
  return <div id="editor-inicio" className="relative min-w-0 overflow-hidden bg-slate-50">
    ...
    {activeView === 'simulation' ? <section className="min-h-[720px] bg-slate-100 px-3 py-6 sm:px-6 sm:py-10"><div className="mx-auto w-full max-w-6xl"><CampaignFinanceSimulatorInline campaign={props.campaign} eventInfo={props.eventInfo} vehicles={props.vehicles} primaryColor={draftV3.primaryColor} cardRadius={draftV3.cardRadius} backgroundColor={draftV3.simulatorBackground} summaryBackgroundColor={draftV3.simulatorSummaryBackground} layoutMode={props.device} /></div></section> : null}
