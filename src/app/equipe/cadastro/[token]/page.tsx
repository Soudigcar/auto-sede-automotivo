...
export default function TeamRegistrationPage() {
  ...
  async function checkEmail(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setExistingName(payload.full_name || '');
