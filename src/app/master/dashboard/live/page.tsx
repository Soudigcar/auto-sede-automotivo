...
import { ArrowRightLeft, BarChart3, Car, Inbox, Landmark, RefreshCcw, Sparkles, Trophy, Users, Wallet } from 'lucide-react';
      ...
      <section className="mx-auto flex max-w-[1600px] overflow-hidden rounded-[28px] border border-white/10 bg-white shadow-2xl shadow-black/50">
        ...
        <div className="min-w-0 flex-1 bg-[#F4F6FA] p-4 md:p-7">
          ...
          <section className="mt-5 grid gap-4 lg:grid-cols-3">
            ...
            <label className="rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-xs font-semibold text-zinc-500 shadow-sm">Período<select className="mt-1 w-full bg-transparent text-base font-black text-zinc-950 outline-none"><option>Última Semana</option></select></label>
          </section>
          ...
          <section className="mt-5 grid gap-5 xl:grid-cols-[1.35fr_1fr]">
            <div className="rounded-[24px] border border-zinc-200 bg-white p-5 shadow-sm md:p-7">
              <div className="flex items-center justify-between gap-4"><div><h2 className="text-xl font-black text-zinc-950">Funil comercial do evento</h2><p className="mt-1 text-sm text-zinc-500">Da abordagem inicial até a venda final.</p></div><BarChart3 className="text-red-600" /></div>
            ...
            <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-1">
              <ChartCard title="Conversão por Categoria" />
              <HeatmapCard />
            </div>
          </section>
