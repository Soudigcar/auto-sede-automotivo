...
import { BarChart3, CalendarDays, Car, FileText, KeyRound, Pencil, Store, Trash2, UserCog } from 'lucide-react';
    ...
    <main className="premium-page">
      <section className="premium-shell flex min-h-screen">
        ...
        <div className="premium-canvas min-w-0 flex-1 p-4 md:p-7">
          <header className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between"><div><p className="premium-eyebrow">Gestao Master</p><h1 className="premium-title mt-2 text-4xl md:text-5xl">Lojas Participantes</h1><p className="premium-muted mt-3 max-w-3xl text-sm">Cadastre lojas, gere senha provisória, edite ou remova lojas ativas.</p></div><Link href="/master/dashboard/live" className="premium-button-secondary"><BarChart3 size={18} /> Voltar ao Dashboard</Link></header>
