...
-- Preserve the strongest historical link first: the operational lead already routed.
...
-- Use the landing/campaign relationship only when no operational relationship exists.
update public.leads_base as base
