-- Canonical store operational profile belongs to the CRM Production source of truth.
-- This migration is versioned only in the cutover branch at this stage.
-- Do not apply to Production before Preview validation and explicit publication authorization.
