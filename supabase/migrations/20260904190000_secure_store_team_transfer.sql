...
-- Inactive profiles must not continue resolving tenant/role/user authorization context.
...
begin
  ...
  -- Preserve former-store leads, conversations, appointments and audit history.
  -- Only the collaborator's active tenant context moves.
